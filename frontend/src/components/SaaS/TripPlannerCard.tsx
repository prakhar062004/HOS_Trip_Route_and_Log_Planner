...
export const TripPlannerCard: React.FC<TripPlannerCardProps> = ({ onSubmit, isLoading }) => {
  ...
  return (
    <div className="w-full border border-slate-200/50 dark:border-slate-800/50 bg-white dark:bg-slate-900 rounded-3xl p-5 md:p-6 shadow-lg shadow-slate-100/40 dark:shadow-none transition-colors duration-300">
