    ...
    <section className="relative w-full max-w-[1360px] mx-auto px-4 mt-6 no-print overflow-hidden rounded-3xl">
      ...
      <div className="w-full border border-slate-200/40 dark:border-slate-800/35 rounded-3xl px-6 py-12 md:py-20 md:px-12 flex flex-col md:flex-row items-center justify-between gap-10 transition-colors duration-300 bg-white/20 dark:bg-slate-900/10 backdrop-blur-md">
        ...
        >
          ...
          <div className="relative p-6 bg-white/40 dark:bg-slate-900/30 backdrop-blur-sm rounded-2xl border border-slate-200/50 dark:border-slate-800/50 shadow-inner flex items-center justify-center group overflow-hidden cursor-pointer">
            {/* Embedded styles for keyframe truck motion on group-hover */}
            ...
            >
              ...
              <line 
                ...
                strokeWidth="3" 
                strokeDasharray="6 4"
                className="animate-road-drive" 
              />
              
              {/* Animated Truck Body Group */}
              <g className="animate-truck-bob origin-bottom">
                {/* Semi-trailer block */}
